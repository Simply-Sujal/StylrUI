        ...
        <div className='w-full'>
            <div className='max-w-[400px] flex flex-col md:flex-row gap-4 md:gap-8 mx-auto'>
                <Link
                    to="/docs"
                    onClick={scrollToTop}
                    className="inline-flex items-center justify-center px-6 py-2 text-base font-roboto font-bold tracking-wider leading-6 text-white whitespace-no-wrap bg-orange-600 border border-orange-700 rounded-lg shadow-sm hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-all duration-100"
