...
const UserInfo = () => {
    ...
    return (
        <section className='w-full'>
            <main className='flex flex-col lg:flex-row justify-center px-4 sm:px-20 bg-gray-100'>
                <div className='w-full lg:w-2/3 relative bg-white rounded-tl-xl rounded-tr-xl'>
                    ...
                    <div className='mt-24 sm:mt-6 ml-5 md:ml-64 pb-2'>
                    ...
                    <div className='mt-24 sm:mt-6 ml-10 bg-white rounded-lg p-6'>
                ...
                <div className='w-full lg:w-1/3 h-[120px] bg-white p-5 mt-10 lg:mt-0 lg:ml-5 rounded-lg shadow-md'>
