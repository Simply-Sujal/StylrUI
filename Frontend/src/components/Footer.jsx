                ...
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div className="md:flex md:justify-between">
                        <div className="mb-6 md:mb-0">
                            <Link to="https://skillez.in/" className="flex items-center">
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
                            ...
                            <div>
                                ...
                                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                    <li className="mb-3">
                                        <Link to="https://github.com/themesberg/KK" className="hover:underline">Github Discussion</Link>
                                    </li>
                                    <li className="mb-3">
                                        <Link to="https://discord.gg/4eeurUVvTy" className="hover:underline">Contact Us</Link>
                                    </li>
                                    <li className="mb-3">
                                        <Link to="https://discord.gg/4eeurUVvTy" className="hover:underline">Join Team</Link>
                                    </li>
                                </ul>
                            </div>
                            <div>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <Link to="/" className="hover:underline">StylrUI</Link>. All Rights Reserved.</span>
